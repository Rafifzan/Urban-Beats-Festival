...
<head>
    ...
    <title>Drop your bio below</title>

</head>
<body>
<div class="formulir-rsvp">
        <h1>Drop your bio below!</h1>
        <form id="registration-form" action="../Model/registration.php" method="POST" onsubmit="confirmSubmission(event);">
            ...
            <input type="number" name="guests_count" placeholder="pax" maxlength="1" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
            <textarea name="notes" placeholder="your thoughts!"></textarea>
            <blockquote>*<strong>Notes:</strong>check your vibe on </blockquote>
